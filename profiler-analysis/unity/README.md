...
| `Assets/AIProfiler/Runtime/Miku/MikuLuaProfilerBackend.cs` | 运行时（`#if AI_PROFILER_MIKU`） | MikuLuaProfiler 适配：基于上游公开 API，扩展点反射探测。详见 [Miku-LuaProfiler/README.md](Miku-LuaProfiler/README.md) |
...
5. **Lua 后端**：见 [Miku-LuaProfiler/README.md](Miku-LuaProfiler/README.md)。
